                ...
                <div className="col-sm-12 col-md-4">
                    <Card style={{ width: '18rem' }} className="m-4 ">
                        ...
                        <Card.Body>
                            ...
                            <Card.Link href={"/examinations/gre"}>View Details</Card.Link>
                        </Card.Body>
                    </Card>
                </div>
                ...
                <div className="col-sm-12 col-md-4">
                    <Card style={{ width: '18rem' }} className="m-4">
                        ...
                        <Card.Body>
                            ...
                            <Card.Link href={"/examinations/ielts"}>View Details</Card.Link>
                        </Card.Body>
                    </Card>
                </div>
                ...
                <div className="col-sm-12 col-md-4">
                    <Card style={{ width: '18rem' }} className="m-4">
                        ...
                        <Card.Body>
                            ...
                            <Card.Link href={"/examinations/toefl"}>View Details</Card.Link>
                        </Card.Body>
                    </Card>
                </div>
                ...
                <div className="col-sm-12 col-md-4">
                    <Card style={{ width: '18rem' }} className="m-4">
                        ...
                        <Card.Body>
                            ...
                            <Card.Link href={"/examinations/gmat"}>View Details</Card.Link>
                        </Card.Body>
                    </Card>
                </div>
                ...
                <div className="col-sm-12 col-md-4">
                    <Card style={{ width: '18rem' }} className="m-4">
                        ...
                        <Card.Body>
                            ...
                            <Card.Link href={"/examinations/gate"}>View Details</Card.Link>
                        </Card.Body>
                    </Card>
                </div>
                ...
                <div className="col-sm-12 col-md-3">
                    <Card style={{ width: '18rem' }} className="m-4">
                        ...
                        <Card.Body>
                            ...
                            <Card.Link href={"/examinations/cat"}>View Details</Card.Link>
                        </Card.Body>
                    </Card>
                </div>
